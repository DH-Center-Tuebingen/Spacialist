...
Route::middleware(['before' => 'jwt.auth', 'after' => 'jwt.refresh'])->prefix('v1/entity')->group(function() {
    ...
    Route::patch('/{id}/attribute/{aid}/moderation/deny', 'EntityController@denyModeration')->where('id', '[0-9]+')->where('aid', '[0-9]+');
    Route::patch('/{id}/attribute/{aid}/moderation/accept', 'EntityController@acceptModeration')->where('id', '[0-9]+')->where('aid', '[0-9]+');
