...
Route::get('/editor/dm', 'HomeController@dme')->name('dme');
Route::get('/editor/layer', 'HomeController@layer')->name('layer');

Route::get('/tool/gis', 'HomeController@gis')->name('gis');
Route::get('/tool/bibliography', 'HomeController@bibliography')->name('bibliography');
Route::get('/tool/analysis', 'HomeController@analysis')->name('analysis');

Route::get('/mg/users', 'HomeController@users')->name('users');
Route::get('/mg/roles', 'HomeController@roles')->name('roles');
