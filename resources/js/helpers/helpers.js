...
const UNSET_CERTAINTY = {type: 'unset', icon: 'fas fa-fw fa-question', class: 'opacity-25', rangeFunction: (certainty) => certainty == null || certainty < 0 || certainty > 100};
export function getCertainties() {
    ...
    return [
        {type: 'danger', icon: 'fas fa-fw fa-question', rangeFunction: inRangeOf(0, 25)},
        {type: 'warning', icon: 'fas fa-fw fa-question', rangeFunction: inRangeOf(25, 50)},
        {type: 'info', icon: 'fas fa-fw fa-question', rangeFunction: inRangeOf(50, 100)},
