<template>
    <div class="d-flex flex-column h-100 px-3 overflow-y-auto overflow-x-hidden">
        ...
        >
            This page allows open access to the Spacialist Project <span class="fst-italic">{{ state.project }}</span> by <a
                :href="`mailto:${state.maintainer.email}`"
                class="fst-italic"
            >{{ state.maintainer.name }}</a>.
        </p>
