<template>
    <div class="dropdown-menu show">
        <a href="#" class="dropdown-item disabled" @click.stop.prevent @dblclick.stop.prevent>
            {{ data.data.name }}
        </a>
        <a href="#" class="dropdown-item" @click.stop.prevent="data.data.onContextMenuAdd(data.data, data.path)" @dblclick.stop.prevent>
