<template>
  <vue-final-modal
    ...
    content-class=""
    name="reset-user-password-modal">
    <div class="sp-modal-content sp-modal-content-xs">
        <div class="modal-header">
            <h5 class="modal-title">
                {{
                    t('main.user.modal.reset_password.title')
                }}
            </h5>
        ...
        <div class="modal-body">
            <form id="resetUserPasswordForm" name="resetUserPasswordForm" role="form" @submit.prevent="onConfirm()">
                <div class="mb-3">
        ...
        <div class="modal-footer">
            <button type="submit" class="btn btn-outline-success" :disabled="!state.form.dirty || !state.form.valid" form="resetUserPasswordForm">
