<template>
    <div class="row">
        <div class="col-md-4">
            <form role="form" id="filter-activity-form" v-show="!hideFilterPanel" name="filter-activity-form" @submit.prevent="filterActivity(filters)">
            ...
            <div :class="{'mt-3': !hideFilterPanel}">
