...
class Attribute extends Model
{
    ...
    public function entities() {
        return $this->belongsToMany('App\Entity', 'attribute_values')->withPivot('entity_val', 'str_val', 'int_val', 'dbl_val', 'dt_val', 'certainty', 'lasteditor', 'thesaurus_val', 'json_val', 'geography_val');
    }
