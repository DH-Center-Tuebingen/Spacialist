...
class InvalidDataException extends Exception
{
    ...
    private static function attributeString(){
        return new self(__('dictionary.value'));
    }
    ...
    public static function requireRange(string $value,  string $from, string $to){
        return new self(__('validation.between', ['attribute' => self::attributeString(),'min' => $from, 'max' => $to]), $value);
    }
    ...
    public static function invalidUsers(array $users){
        return self::objectNotFound('user', $users);
    }
