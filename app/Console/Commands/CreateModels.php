...
class CreateModels extends Command
{
     ...
     * @var string
     */
    protected $signature = 'spacialist:create {--r|role : Whether a role should be created} {--u|user : Whether a user should be created (default)} {name=admin : Name of the new user/role}';
