...
class ApiMapTest extends TestCase
{
    ...
    public function testExportUnlinkedLayerEndpoint()
    {
        ...
        $this->assertEquals(3493381.81073, round(floatval($data[0]), 5));
        $this->assertEquals(5378579.86081, round(floatval($data[1]), 5));
        $this->assertEquals(-52.26836, round(floatval($data[2]), 5));
