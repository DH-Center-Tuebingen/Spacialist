...
return [
    ...
    'entity-type-does-not-exist' => 'Der Entitäts-Typ existiert nicht: :type',
    'entity-type-relation-not-allowed' => 'Die Beziehung zwischen Entitäts-Typen ist nicht zulässig: :parent -> :child',
    'entity-already-exists' => 'Die Entität existiert bereits: :entity',
    'name-column-empty' => 'Name fehlt',
    'no-headers-found' => 'Keine Spalten gefunden'
];
